		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comeamtrassetzeamtrasset-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comeamtrassetzeamtrasset-display": {
								"semanticObject": "comeamtrassetzeamtrasset",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.eam.tr.asset",
									"url": sap.ui.require.toUrl("com/eam/tr/asset")
								}
							}
						}
					}
